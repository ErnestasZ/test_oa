...
//  
//  $to = $email;
//  $message = "Your request was sent succsessfuly!<br><br>Name: " . $name . "<br><br> Description: " . $description . "<br><br>OASIS DOME";
//  $subject = "Request received";
//  $headers = "MIME-Version: 1.0" . "\r\n";
//  $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
//  
//  $headers .= 'From: <order@oasisdome.eu>' . "\r\n";
//  $headers .= 'Bcc: ernestas.zemaitis@gmail.com' . "\r\n";
              ...
              <!-- Text input-->
               <div class="form-group">
                  ...
                  <div >
                    ...
                    <!-- Success message -->
                    <div class="alert alert-success" role="alert" id="success_message">Succeeded! <i class="glyphicon glyphicon-thumbs-up"></i> Thanks for contacting us, we will get back to you shortly.</div>
...
<!--                    <label for="inputComment" class="control-label">Address</label>-->
              ...
              <div class="form-group" align="center">
                <button type="submit" class="btn btn-outline btn-xl" name="send" data-toggle="modal" data-target="#myModal">send</button>
              </div>
            </form>
