    ...
    <section class="download bg-primary text-center content-oasis">
        <div class="container">
            ...
            <div class="row" >
              ...
              <div class="col-sm-6 col-sm-offset-3">
                    <h1 class="oasis-cont content-features">ADDS</h1>
...
<section class="download bg-primary text-center content-oasis">
 <div class="container">
  <row>
    <div class="col-sm-6 col-sm-offset-3">
      <h1 class="oasis-cont content-features">Oasis 2 dimentions</h1>
...
<section class="download bg-primary text-center content-oasis">
 <div class="container">
  <row>
    <div class="col-sm-6 col-sm-offset-3">
      <h1 class="oasis-cont content-features">Parts included</h1>
      <p>Oiled plywood floors, arches, construction parts, <br>
      bottom and upper canopy, doors and ventilation with anti-insect meshes, <br>
...
<section class="download bg-primary text-center content-oasis">
 <div class="container">
  <row>
    <div class="col-sm-6 col-sm-offset-3">
      <h1 class="oasis-cont content-features">Assembly duration</h1>
    </div>
  </row>
  <row>
    <div class="col-sm-6 col-sm-offset-3">
...
<section class="download bg-primary text-center content-oasis">
 <div class="container">
  <row>
    <div class="col-sm-6 col-sm-offset-3">
      <h1 class="oasis-cont content-features">Transportation</h1>
      <p>Worldwide. <br>
...
<section class="download bg-primary text-center content-oasis">
 <div class="container">
  <row>
    <div class="col-sm-6 col-sm-offset-3">
      <h1 class="oasis-cont content-features">OASIS 2 package</h1>
...
<section class="download bg-primary text-center content-oasis">
 <div class="container">
  <row>
    <div class="col-sm-6 col-sm-offset-3">
      <h1 class="oasis-cont content-features">Guarantee</h1>
